  ...
  server.registerTool(
    ...
    async () => {
      try {
        ...
        const [cyclesResult, recoveriesResult, sleepsResult, workoutsResult] = await Promise.all([
        ...
        const warnings: string[] = [
          ...
          workoutsResult.truncated && "Workout data truncated at 50 pages — some history omitted",
