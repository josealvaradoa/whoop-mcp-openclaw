...
export function registerRaceReadinessTool(server: McpServer): void {
  server.tool(
    "get_race_readiness",
    "Get race readiness assessment: days to race, current training phase, fitness trend, fatigue status, key concerns, and a weekly summary. Uses the configured race date and periodization phases.",
    {},
    async () => {
